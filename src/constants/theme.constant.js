...
export const SIDE_NAV_CONTENT_GUTTER = 'px-0'
export const LOGO_X_GUTTER = 'p-6'
export const HEADER_HEIGHT_CLASS = 'h-16'
export const PAGE_CONTAINER_GUTTER_X = 'px-0 sm:px-0 md:px-0'
export const PAGE_CONTAINER_GUTTER_Y = 'py-0 sm:py-0 md:px-0'
