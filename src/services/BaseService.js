...
import { TOKEN_TYPE, REQUEST_HEADER_AUTH_KEY,REQUEST_HEADER_TOKEN_KEY_NAME,REQUEST_HEADER_FINGERPRINT_KEY_NAME } from 'constants/api.constant'
...
const BaseService = axios.create({
    timeout: 60000,
    baseURL: "https://predev-api.readabilitytutor.com/API/v1" //appConfig.apiPrefix,
})
