			...
			<FormItem>
				<Field name="imgList">
					{({ field, form }) => {
						...
						return (
							<>
							<div className="grid grid-cols-2 grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4">
							<Upload
								beforeUpload={beforeUpload}
								onChange={files => onUpload(form, field, files)}
								showList={false}
							...
							>
								<div className="my-4 text-center">
									...
									<span className="text-gray-800 dark:text-white">Cover Image of Book </span>
								</div>
							...
							>
								<div className="my-4 text-center">
									...
									<span className="text-gray-800 dark:text-white">Copyright Image of Book </span>
								</div>
