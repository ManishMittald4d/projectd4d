...
const validationSchema = Yup.object().shape({
	...
	insname: Yup.number().required('Institution Name Required'),
			...
			>
				{({values, touched, errors, isSubmitting}) => (
					...
					<div className='flex flex-wrap justify-between items-center px-4'>
						...
						<div className='mr-2'><h5 className='items-center'>Teacher </h5></div>
						<div><p className='text-[##B5B5C3]'>Add Teacher</p></div>
