...
import { getProjectDashboardData } from 'store/readability/readabilitySlice';
...
const CurrentSubscription = () => {
	...
	const {
		userName,
	} = useSelector((state) => state?.readability?.dashboardData)
	...
	const data = useSelector((state) => state?.readability?.subscriptionData)
