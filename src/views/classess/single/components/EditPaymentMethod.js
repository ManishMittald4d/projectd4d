...
import { closeEditPaymentMethodDialog } from 'store/readability/readabilityStateSlice'
...
const EditPaymentMethod = () => {
	...
	const card = useSelector((state) => state.readabilityState?.selectedCard)
	const data = useSelector((state) => state.readability?.paymentMethodData)
	const dialogOpen = useSelector((state) => state.readabilityState?.editPaymentMethodDialog)
	const selectedCard = useSelector((state) => state.readabilityState?.selectedCard)
