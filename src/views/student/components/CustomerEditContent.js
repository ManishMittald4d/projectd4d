...
import { setCustomerList, putCustomer } from 'store/readability/readabilitySlice'
import { setDrawerClose } from 'store/readability/readabilityStateSlice'
...
const CustomerEditContent = forwardRef((_, ref) => {
	...
	const customer = useSelector((state) => state?.readabilityState?.selectedCustomer)
