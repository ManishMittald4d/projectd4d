...
import { getInstitutions,setTableData } from 'store/readability/readabilitySlice'
	...
	return (
		...
		<ReadabilityDrawer  />
			<div className="lg:flex xl:flex items-center justify-between mb-4">
				<div className="justify-center flex flex-wrap lg:flex xl:flex md:flex items-center gap-2">
					<div className='flex items-center justify-center'>
						...
						<span className="text-dark-50 font-weight-bold _SearchTotalCountBox">
							...
							<span className="text-[#3699FF]">(in 15.01 sec)
							</span>
						</span>
					</div>
				...
				<div className="flex items-center justify-center">
					...
					<Tooltip  title={'Add Institution using page'} wrapperClass="mr-1">	
					<Link 
						...
						<span className='mt-2'>Add Institution</span>	
					...
					<Tooltip  title={'Add Institution using Panel'} wrapperClass="mr-1">
					<div onClick={() => handleShowMoreDetail('addinstitute')} className='flex text-[#3699FF] bg-[#E1F0FF] mr-2 cursor-pointer'>
						<div>	
						<Button className="text-[#3699FF] hover:text-[#3699FF] hover:bg-[#E1F0FF]" shape="normal" variant="plain" size="sm" icon={<MdAdd />}/>
						</div>
						<div className='pt-2 mr-2 font-bold'>
		...
		<div className="lg:flex xl:flex items-center justify-between mb-4">
			<div>
				...
				<CustomerTableSearch className="" placeholder ="Insitution" ref={inputRef} onInputChange={handleInputChange} />
				</div>
				<div>
