...
import { getCustomerBooks, setTableData } from 'store/readability/readabilitySlice'
import CustomerTableSearch from './CustomerTableSearch'
import { MdHelpOutline ,MdPostAdd ,MdListAlt ,MdFilterAlt} from 'react-icons/md';
...
const CustomersTableTools = () => {
	...
	const fetchData = data => {
		...
		console.log('fetch data',dispatch(setTableData(data)));
		console.log('fetch data',dispatch(setTableData(data)));
		dispatch(getCustomerBooks(data))
	}
